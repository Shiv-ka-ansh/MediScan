...
export const Home = () => {
  ...
  return (
    <div className="relative isolate overflow-hidden" style={{ background: '#F1F5F9' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-in fade-in slide-in-from-left-8 duration-1000 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start mb-8">
              <div className="relative">
                ...
                <div className="relative p-4 bg-white rounded-3xl shadow-lg border border-slate-200 ring-1 ring-sky-400/30">
            ...
            <h1 className="text-5xl md:text-7xl font-outfit font-extrabold mb-6 tracking-tight leading-[1.1] text-slate-900">
              Future of{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 via-cyan-500 to-indigo-500 animate-gradient-x">
                Health Intelligence
              </span>
            </h1>

            <p className="text-xl text-slate-500 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed font-inter">
              ...
              {user ? (
                <>
                  ...
                  <Link to="/upload" className="w-full sm:w-auto">
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full border-slate-300 hover:bg-slate-100 text-slate-700 transition-all"
                    >
                ...
                <>
                  <Link to="/register" className="w-full sm:w-auto">
                    <Button
                      size="lg"
                      className="w-full btn-gradient px-12 shadow-md hover:shadow-lg transition-all"
                    >
                      Get Started Free
                    </Button>
                  </Link>
                  <Link to="/login" className="w-full sm:w-auto">
                    <Button
                      variant="ghost"
                      size="lg"
                      className="w-full text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all"
                    >
          ...
          <div className="hidden lg:block relative animate-in fade-in zoom-in duration-1000 delay-200">
            <div className="relative glass-card p-6 border border-slate-200 rounded-3xl overflow-hidden group shadow-xl" style={{background:'rgba(255,255,255,0.9)'}}>
              {/* Scan Line Animation */}
              <div
              ...
              <div className="flex items-center justify-between mb-8 border-b border-slate-100 pb-4">
                ...
                <div className="text-right">
                  <span className="px-2 py-1 bg-sky-50 text-sky-500 text-[10px] rounded-full border border-sky-200 font-bold">
                    AI VERIFIED
                  </span>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-indigo-50 border border-indigo-200 rounded-2xl">
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto border-t border-slate-200 pt-12">
          {[
            ...
            <div key={i} className="text-center group">
              <div className="text-3xl font-outfit font-bold text-slate-900 mb-1 group-hover:text-sky-500 transition-colors">
                <CountUp
                  end={stat.value}
                  suffix={stat.suffix}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-outfit font-bold mb-4 text-slate-900">
...
const MetricRow = ({ label, value, status, color, warning = false }) => (
  <div className="flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors">
    ...
    <div className="flex items-center gap-2">
      <span className="text-slate-900 text-xs font-bold font-mono">{value}</span>
...
const FeatureCard = ({ icon, title, desc, accent }) => (
  <div className="glass-card p-8 hover:shadow-lg transition-all duration-500 group cursor-default relative overflow-hidden border border-slate-200">
    <div
      className={`absolute top-0 right-0 w-24 h-24 -mr-12 -mt-12 bg-sky-500/5 rounded-full blur-2xl group-hover:bg-sky-500/10 transition-all duration-500`}
    ></div>
    <div
      className={`mb-6 p-3 bg-slate-100 w-fit rounded-2xl transition-all duration-500 ${accent} group-hover:text-white`}
    >
      {icon}
    </div>
    <h3 className="text-2xl font-outfit font-bold mb-3 text-slate-900 group-hover:translate-x-1 transition-transform">
      {title}
    </h3>
