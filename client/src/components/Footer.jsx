      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm mb-6 font-inter leading-relaxed">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-outfit font-bold mb-4 uppercase tracking-wider text-sm">Platform</h4>
            <ul className="space-y-3 text-sm text-slate-400 font-inter">
              <li><Link to="/upload" className="hover:text-cyan-400 transition-colors">Upload Report</Link></li>
              <li><Link to="/chat" className="hover:text-cyan-400 transition-colors">AI Assistant</Link></li>
              <li><Link to="/reference-values" className="hover:text-cyan-400 transition-colors">Lab Values Reference</Link></li>
              <li><Link to="/dashboard" className="hover:text-cyan-400 transition-colors">Patient Dashboard</Link></li>
            </ul>
          </div>

          {/* Legal */}
          <div>
            <h4 className="text-white font-outfit font-bold mb-4 uppercase tracking-wider text-sm">Legal & Privacy</h4>
            <ul className="space-y-3 text-sm text-slate-400 font-inter">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-outfit font-bold mb-4 uppercase tracking-wider text-sm">Contact</h4>
            <ul className="space-y-3 text-sm text-slate-400 font-inter">
              <li className="flex items-center gap-2">
                <Mail size={16} className="text-cyan-400" />
                <a href="mailto:support@mediscan.ai" className="hover:text-white transition-colors">support@mediscan.ai</a>
              </li>
